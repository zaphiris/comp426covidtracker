...
import {CovidService, ElectionState, State} from '../covidservice.service';
...
export class ElectionWrapper {
  ...
  circleCords = [
    { state: 'NC', x: '789', y: '323' },
    { state: 'SC', x: '759', y: '371' },
    { state: 'GA', x: '713', y: '402' },
    { state: 'FL', x: '767', y: '501' },
    { state: 'AL', x: '654', y: '397' },
    { state: 'MS', x: '603', y: '405' },
    { state: 'TN', x: '655', y: '336' },
    { state: 'VA', x: '787', y: '286' },
    { state: 'TX', x: '419', y: '448' },
    { state: 'CA', x: '70', y: '270' },
    { state: 'WA', x: '125', y: '50' },
    { state: 'OR', x: '94', y: '121' },
    { state: 'MN', x: '886', y: '78' },
    { state: 'PA', x: '782', y: '209' },
    { state: 'NV', x: '139', y: '238' },
    { state: 'ND', x: '413', y: '95' },
    { state: 'SD', x: '413', y: '160' },
    { state: 'AZ', x: '209', y: '361' },
    { state: 'NM', x: '301', y: '363' },
    { state: 'AK', x: '111', y: '493' },
    { state: 'HI', x: '262', y: '564' },
    { state: 'OK', x: '457', y: '355' },
    { state: 'KS', x: '441', y: '289' },
    { state: 'UT', x: '224', y: '256' },
    { state: 'WY', x: '300', y: '180' },
    { state: 'NE', x: '421', y: '221' },
    { state: 'LA', x: '553', y: '448' },
    { state: 'KY', x: '668', y: '301' },
    { state: 'AR', x: '545', y: '372' },
    { state: 'MO', x: '542', y: '289' },
    { state: 'IL', x: '597', y: '249' },
    { state: 'IA', x: '520', y: '210' },
    { state: 'IN', x: '643', y: '248' },
    { state: 'OH', x: '699', y: '237' },
    { state: 'WV', x: '742', y: '265' },
    { state: 'CO', x: '320', y: '271' },
    { state: 'MI', x: '660', y: '176' },
    { state: 'NY', x: '817', y: '154' },
    { state: 'VT', x: '841', y: '84' },
    { state: 'MA', x: '921', y: '141' },
    { state: 'RI', x: '897', y: '191' },
    { state: 'CT', x: '872', y: '212' },
    { state: 'NJ', x: '863', y: '245' },
    { state: 'MD', x: '848', y: '289' },
    { state: 'DE', x: '877', y: '275' },
    { state: 'MT', x: '281', y: '86' },
    { state: 'ID', x: '191', y: '138' },
    { state: 'ME', x: '501', y: '127' },
    { state: 'WI', x: '581', y: '155' },
    { state: 'MI', x: '628', y: '83' },
    { state: 'NH', x: '850', y: '70'},
    { state: 'DC', x: '0', y: '0'}
  ];
  ...
  svgCords = [
    ...
    {
      state: 'WI',
      cords: 'M541.4 109.9l2.9.5 2.9-.6 7.4-3.2 2.9-1.9 2.1-.8 1.9 1.5-1.1 1.1-1.9 3.1-.6 1.9 1 .6 1.8-1 1.1-.2 2.7.8.6 1.1 1.1.2.6-1.1 4 5.3 8.2 1.2 8.2 2.2 2.6 1.1 12.3 2.6 1.6 2.3 3.6 1.2L609 138l1.6 1.4 1.5.9-1.1 2.3-1.8 1.6-2.1 4.7-1.3 2.4.2 1.8 1.5.3 1.1-1.9 1.5-.8.8-2.3 1.9-1.8 2.7-4 4.2-6.3.8-.5.3 1-.2 2.3-2.9 6.8-2.7 5.7-.5 3.2-.6 2.6.8 1.3-.2 2.7-1.9 2.4-.5 1.8.6 3.6.6 3.4-1.5 2.6-.8 2.9-1 3.1 1.1 2.4.6 6.1 1.6 4.5-.2 3-15.9 1.8-17.5 1H567l-.7-1.5-2.9-.4-2.6-1.3-2.3-3.7-.3-3.6 2-2.9-.5-1.4-2.1-2.2-.8-3.3-.6-6.8-2.1-2.5-7-4.5-3.8-5.4-3.4-1-2.2-2.8h-3.2l-2.9-3.3-.5-6.5.1-3.8 1.5-3.1-.8-3.2-2.5-2.8 1.8-5.4 5.2-3.8 1.6-1.9-.2-8.1.2-2.8 2.4-2.8z'
    },
    {
      state: 'WV',
    ...
    {
      state: 'WY',
      cords: 'M353 161.9l-1.5 25.4-4.4 44-2.7-.3-83.3-9.1-27.9-3 2-12 6.9-41 3.8-24.2 1.3-11.2 48.2 7 59.1 6.5z'
    }, {
      state: 'DC',
      cords: ''
    }
  ...
  constructor(array: ElectionState[]) {
  this.states = array;
    }

  public getStateColor(stateCode: string) {
    let d = this.states.find(element => element.state_po == stateCode);
    return "#" + d.calculateStateColor();
  }

  public getStateCord(stateCode: string) {
    let d = this.svgCords.find(element => element.state == stateCode);
    return d.cords;
  }

  public getStateCircleX(stateCode: string) {
    let d = this.circleCords.find(element => element.state == stateCode);
    return d.x;
  }

  public getStateTextX(stateCode: string) {
    let d = this.circleCords.find(element => element.state == stateCode);
    return parseInt(d.x) + 10;
  }

  public getStateCircleY(stateCode: string) {
    let d = this.circleCords.find(element => element.state == stateCode);
    return d.y;
  }
...
export class CovidWrapper {
  ...
  public getCovidSize(stateCode: string) {
    let d = this.states.find(element => element.state == stateCode);
    return Math.log(d.positive/d.totalTestResults * 200)*(d.positive/d.totalTestResults * 30);
  }

  getPercentage(stateCode: string) {
    let d = this.states.find(element => element.state == stateCode);
    return Math.round(d.positive/d.totalTestResults * 100);
  }
}
...
export class HomepageMapWidgetComponent implements OnInit {
  ...
  years;
  electionData = [];
  electionObject: ElectionWrapper;
  covidData = [];
  covidObject: CovidWrapper;
  loadPage: boolean = false;
  show: boolean = true;
  covidServiceGlob: CovidService;
  ...
  parentEventHandlerFunction(valueEmitted){
    ...
    this.covidServiceGlob.sendElectionRequest(valueEmitted).subscribe((data) => {
      ...
      for (let i = 0; i < JSON.parse(JSON.stringify(data)).length; i++) {
        newArr[i] = plainToClass(ElectionState, data[i]);
      }

      this.electionData = newArr;
      this.electionObject = new ElectionWrapper(newArr);
      this.loadPage = true;
  ...
  constructor(private covidService: CovidService, private userService: UserService, router: Router) {
    ...
    this.covidServiceGlob = covidService;
    this.covidService.sendGetRequest().subscribe((data: State[]) => {
      this.states = data;

      let newArr = new Array();
      for (let i = 0; i < JSON.parse(JSON.stringify(data)).length; i++) {
        newArr[i] = plainToClass(State, data[i]);
      }

      this.covidData = newArr;
      this.covidObject = new CovidWrapper(newArr);
    ...
    this.covidService.sendElectionRequest(2016).subscribe((data) => {
    ...
    this.covidService.getYearsList().subscribe((data) => {
        this.years = data;
